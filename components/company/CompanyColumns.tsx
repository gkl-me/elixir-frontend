...
import { ArrowUpDown, MoreHorizontal, Eye, Mail, Ban, CheckCircle } from 'lucide-react'
    ...
    return [
        ...
        },
        {
            ...
            cell: ({ row }) => {
                ...
                if (status === 'blocked') { badgeClass = "bg-gradient-to-r from-red-500 to-red-600" }
                if (status === 'pending') { badgeClass = "bg-gradient-to-r from-yellow-500 to-yellow-600" }
