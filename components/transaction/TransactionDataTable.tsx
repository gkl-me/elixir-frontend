...
import { DollarSign, CheckCircle2, RefreshCw, AlertOctagon, ArrowUpRight } from "lucide-react";
      ...
      <div className="relative min-w-[140px]">
        ...
        >
          ...
          <SelectContent className="border-navy/50 bg-navy text-white">
            ...
            <SelectItem value="success" className="cursor-pointer focus:bg-purple/20 focus:text-white">
              Success
            </SelectItem>
            <SelectItem value="pending" className="cursor-pointer focus:bg-purple/20 focus:text-white">
              Pending
            </SelectItem>
            <SelectItem value="failed" className="cursor-pointer focus:bg-purple/20 focus:text-white">
              Failed
            </SelectItem>
          </SelectContent>
        </Select>
