    ...
    <CustomForm
      ...
      fields={[
          ...
          component: ({ value, onChange, disabled }) => (
            <div className="space-y-2">
              <Select
                ...
                disabled={disabled}
              >
                <SelectTrigger className="border-purpleDark/50 bg-white/5 text-white">
                  <SelectValue placeholder="Select plan type" />
                </SelectTrigger>

                <SelectContent className="border-purpleDark/50 bg-navyDark text-white">
        ...
        },
        {
          ...
          component: ({ value, onChange, disabled }) => (
            <div className="flex flex-row items-center justify-between rounded-lg border border-purpleDark/50 bg-white/5 p-4">
              <div className="space-y-0.5">
                <label className="text-base font-medium text-white">
                  GitHub Automation
                </label>
                <p className="text-sm text-gray-400">
                  Enable GitHub integration features for this plan.
                </p>
              </div>
              <Switch
          ...
          component: ({ value, onChange, disabled }) => (
            <div className="flex flex-row items-center justify-between rounded-lg border border-purpleDark/50 bg-white/5 p-4">
              <div className="space-y-0.5">
                ...
                <p className="text-sm text-gray-400">
                  Allow users to run custom automation scripts.
                </p>
              </div>
              <Switch
                className="data-[state=checked]:bg-green-500 data-[state=unchecked]:bg-gray-600"
