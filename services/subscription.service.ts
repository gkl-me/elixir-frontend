...
export const subscriptionService = {
  ...
  handleCancelSubscription: async (params: ICancelSubscriptionParams) => {
    return api.patch(
      SUBSCRIPTION_API_ROUTES.CANCEL_SUBSCRIPTION(params.subscriptionId),
      {
  ...
  handleReactivateSubscription: async (
    ...
    return api.patch(
      SUBSCRIPTION_API_ROUTES.REACTIVATE_SUBSCRIPTION(params.subscriptionId)
    );
  },
};
