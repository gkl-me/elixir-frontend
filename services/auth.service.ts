...
import { ForgotPasswordData, GithubAuthData, GoogleAuthData, LoginData, LogoutData, RegisterData, ResendOtpData,  ResendVerifyEmailData, ResetPasswordData, VerifyEmailData, VerifyOtpData } from "@/types/IAuthType";
