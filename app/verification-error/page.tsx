  ...
  return (
    <div className="relative flex min-h-screen w-full flex-col items-center justify-center overflow-hidden bg-navyDark p-4">
      ...
      <div className="pointer-events-none absolute inset-0 h-full w-full overflow-hidden">
        <div className="absolute -left-[10%] -top-[20%] h-[50%] w-[50%] rounded-full bg-red-900/10 blur-[120px]" />
        <div className="absolute -right-[10%] top-[40%] h-[40%] w-[40%] rounded-full bg-orange-900/10 blur-[100px]" />
      </div>
        ...
        <div className="flex flex-col items-center gap-6 rounded-2xl border border-white/5 bg-white/5 p-8 shadow-2xl backdrop-blur-xl">
          ...
          <div className="space-y-2 text-center">
            ...
            <p className="text-base text-slate-400">
              We couldn&apos;t verify your account. The link may have expired or
              is invalid.
            </p>
          </div>
          ...
          <div className="flex w-full flex-col gap-3 pt-2">
            ...
            <Link
              ...
              className="flex w-full items-center justify-center rounded-lg border border-white/10 bg-white/5 px-4 py-3 text-sm font-semibold text-white transition-colors hover:bg-white/10"
            >
